...
fun AuthScreen(
    ...
    Column(
        ...
        if (authStep == AuthStep.Guide) {
            ...
            HopesPrimaryButton(stringResource(R.string.login), onNavigateLogin)
        } else {
            HopesSurfaceCard {
                Text(stringResource(if (authStep == AuthStep.SignUp) R.string.signup_subtitle else R.string.login_subtitle))
                ...
                if (authStep == AuthStep.SignUp) {
                    ...
                    HopesPrimaryButton(stringResource(R.string.signup), onSignupClick)
                    Button(onClick = onNavigateLogin) { Text(stringResource(R.string.login)) }
                } else {
                    HopesPrimaryButton(stringResource(R.string.login), onLoginClick)
